...
const AdminReportGenerating = () => {
  const navigate = useNavigate()
  const [currentTime, setCurrentTime] = useState(new Date())
  const [activeTab, setActiveTab] = useState(3) // Set to Reports icon
  ...
  const handleDownloadReport = (reportType, category) => {
    try {
      ...
      doc.setFontSize(20)
      doc.text('ATTENDIQ - Admin Attendance Report', 20, 20)
      ...
      doc.text(`Generated by: Admin`, 20, 65)
      ...
      const filename = `admin-${reportType}-${timestamp}.pdf`
    ...
    <div className="admin-dashboard-container">
      ...
      <div className="left-panel">
        <div className="brand-section">
          ...
          <p className="brand-subtitle">ADMIN REPORT GENERATING</p>
        </div>
      ...
      <div className="main-content">
        ...
        <nav className="top-nav">
          <div className="nav-left">
            <span className="nav-item active">Admin Dashboard</span>
...
export default AdminReportGenerating
